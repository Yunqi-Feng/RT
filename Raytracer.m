...
Mpc = cell(paraCfgInput.numberOfNodes,...
    ...
    max(nPAA_centroids),...
    paraCfgInput.totalNumberOfReflections+2,...
            ...
            for iteratePaaTx = 1:nPAA_centroids(iterateTx)
                ...
                for iteratePaaRx = 1:nPAA_centroids(iterateRx)
                    ...
                    % Higher order reflections (Non LOS)
                        ...
                        [outputDiffraction, multipathDiffraction] = diffractionPathGenerator(Tx, Rx, CADop_diffr, CADop, vtx, vrx, paraCfgInput.carrierFrequency, ...
                            LOS_output,pseudo_LOS_output,paraCfgInput.polarization,Jones,paraCfgInput.Ptx,paraCfgInput.antenna,paraCfgInput.enablePhaseOutput);
